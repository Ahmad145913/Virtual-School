        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>Edit movie details
                        <a href="admin-movies" class="btn btn-danger float-end"
                ...
                <div class="card-body">
                    ...
                    <?php
                    if (isset($_GET['id'])) {
                        $id_movies = mysqli_real_escape_string($con, $_GET['id']);
                        $query = "SELECT * FROM movies WHERE id='$id_movies' ";
                    ...
                    <form action="admin-submit" method="POST">
                        <input type="hidden" name="id_movies" value="<?= $movies['id']; ?>">
                        ...
                        <div>
                            ...
                            <select name="imge" class="form-control">
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    if ($row['filename'] == $movies['image_name']) {
                        ...
                        <div class="mb-3">
                            <button type="submit" name="update_movies" class="btn btn-primary"
